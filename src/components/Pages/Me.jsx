    ...
    return (
      <div className="container">
        <div className="row">
          ...
          <p className="col-sm-9" id="text">
            Hi, my name is Nikola, I am 20 years old, and I live in the north
            part of Belgrade, Zemun. In 2019. I enrolled at the Faculty of
        ...
        <div className="row">
          <p className="col-sm-12" id="text">
            ...
            <li>
              In 2019, enrolled at the Faculty of Organizational Sciences
              majoring in Management and Organization.
            </li>
          ...
          {/*     <div className="col-sm-4" id="imgDiv2">
     <img src={myImage2} alt="" id="myImage2"></img> 
     <img src={myImage3} alt="" id="myImage3"></img> </div> */}
          ...
          <p className="col-sm-9" id="text">
            ...
            teaching me how to be disciplined in every possible situation.
            Rowing is a cruel and ruthless sport that does not forgive any
            mistakes. I quitted rowing in 2019, because I realized I had to
            devote more time learning math for the entrance exam. In my opinion,
            education will always be more valuable than sport. The day after I
            quit rowing, I went to a nearby gym named "Muscle factory gym" and I
            have been training actively ever since. In my gym training I try to
            combine multiple different sports such as bodybuilding,
          ...
          <div className="col-sm-3" id="imgDiv2">
            ...
            {/*  <img src={myImage7} alt="" id="myImage7"></img> */}
          </div>
          ...
          <p className="col-sm-12" id="text">
            ...
            we cannot have healthy and righteous mindsets if we haven't passed
            some bad situations in life. A famous quote will best describe this:
            "What doesn't kill you makes you stronger" and I will add "and makes
            you better". In the previous 4 years, I have changed my personality
            a lot. Credits go to my family, best friend Marko,s and to the
            books. Believe it or not books had a huge impact on my personality,
            especially book written by Mark Manson named "Subtle art of not
            giving a fuck". Lessons that I learned from that book and life are:
            <br></br>
            ...
            <li>
              Don't try to be someone else, just be the best version of
              yourself.
            </li>
            <li>
            ...
            The book enlightened me completely and gave me a base for the
            process of mental change. Three years after reading that book I
            became completely different person.
          </p>
     ...
     <img src={myImage5} alt="" id="myImage5"></img> </div> */}
          ...
          <p className="col-sm-12" id="text">
            ...
            18-year-old teenager when I joined the youth working club. In a
            short period, I worked for a many companies and learned a lot about
            a warehouse, construction, and relocation work. Meanwhile, I learned
            a lot about programming, web design, and fitness. Here is a list of
            my working experience:<br></br>
            <li>
              Warehouse jobs in companies: "Milsped", "Delta transport systems",
              "Gebruder Weiss", "Nelt", "Forbel", and "Union sped".
            </li>
            <li>
              Construction jobs in companies: "MKM Global Building" where I
              worked on the reconstruction of an office from the CEO of "NIS"
              company. "WD Concord West" where I worked as a manual worker on a
              government project of hospital construction.
            </li>
            <li>
