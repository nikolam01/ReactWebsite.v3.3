        ...
        <ul className="timeline">
          ...
          <li className="timeline-inverted">
            ...
            <div className="timeline-panel">
              ...
              <div className="timeline-body">
                <p className="text-muted">
                  It was simple website that I made using HTML, CSS and Netlify
                  platform. It was at basic level of coding in HTML and CSS. The
                  only "advanced" characteristic was responsive design.
                </p>
              </div>
            </div>
          </li>
            ...
            <div className="timeline-panel">
              ...
              <div className="timeline-body">
                <p className="text-muted">
                  ...
                  Numerous libraries and technologies like Node JS, Axios, Mongo
                  DB, etc.
                </p>
              </div>
            </div>
