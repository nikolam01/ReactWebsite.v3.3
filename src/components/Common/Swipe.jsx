...
<div class="swiper-container">
  <div class="swiper-wrapper">
    ...
    <img className="img-fluid" id="swipeImg" src={img1} alt="image1"/>
      </div>
    <div class="swiper-slide">
    <img className="img-fluid"  id="swipeImg" src={img2} alt="image2"/>
    </div>
    <div class="swiper-slide">
    <img className="img-fluid"  id="swipeImg" src={img3} alt="image3"/>
    </div>
  </div>
